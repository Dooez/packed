...
public:
    ...
    fconv_unit(pcx::vector<T> g, std::size_t fft_size, allocator_type allocator = allocator_type{})
...
private:
    fft_unit<T, fft_output::unsorted, pcx::dynamic_size, pcx::dynamic_size, allocator_type> m_fft;
